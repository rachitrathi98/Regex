...

{
...

    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                Console.WriteLine("Check Valid and Invalid email Samples");
                string[] emailSamples = {"abc@outlook.com","abc-100@outlook.com", "abc.100@outlook.100", "abc9852@abc.com",
                 "abc-100@abc.co.in", "abc.100@abc."};
